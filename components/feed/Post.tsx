                    ...
                    <div>
                        {post.img.endsWith('.mp4') || post.img!.endsWith('.webm') || post.img!.endsWith('.ogg') ?
                            <div className="w-full h-full relative">
                                <video autoPlay controls src={post.img!} className='sm:rounded-md object-cover'></video>
                            </div>
                            :
                            <div className="w-full min-h-96 relative">
                                <Image src={post.img!} alt="Uploaded Image" fill className='sm:rounded-md object-cover' />
                            </div>}
                    </div>
                }
            </div>
